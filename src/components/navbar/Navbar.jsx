...
const Navbar = () => {
  ...
  return (
    <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
      <a className="text-3xl font-bold leading-none" href="#">
        <svg className="h-10" viewBox="0 0 10240 10240">
          <path
            ...
            d="M8284 9162 c-2 -207 -55 -427 -161 -667 ... (trimmed for brevity) ..."
          ></path>
        </svg>
      </a>
      ...
      <a className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-semibold rounded-lg transition duration-200">
        Login
      </a>
    </nav>
  );
